...
using ColorCodeStandard.Compilation.Languages;
...
namespace ColorCodeStandard
{
    ...
    public static class Languages
    {
        ...
        /// <remarks>
        ///     If a language with the same identifier has already been loaded, the existing loaded language will be replaced by
